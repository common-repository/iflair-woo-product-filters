<?php 
/**
 * This file is used to markup the setting field select dropdown.
 *
 * @since      1.0
 *
...
<select name="<?php echo esc_attr($field['name_attribute']); ?>"
	...
	<?php if($field['id'] == 'default_sorting') { ?>
	<option><?php echo esc_html__( 'Default choose option', 'iflair-woo-product-filters' );?></option>
	<?php } ?>
	<?php if( $field['select2'] === true && !empty( $field['placeholder'] ) ){ ?>
		<option></option>
